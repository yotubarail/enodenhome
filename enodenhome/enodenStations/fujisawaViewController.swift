...
class fujisawaViewController: UIViewController, UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    // WEBページを見る
    @IBAction func tapFujisawaWeb(_ sender: Any) {
        let nextView = storyboard?.instantiateViewController(withIdentifier: "FujisawaWebChoose") as! FujisawaWebViewController
