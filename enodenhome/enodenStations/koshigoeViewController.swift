...
class koshigoeViewController: UIViewController, UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    @IBOutlet weak var koshigoeImage: UIImageView!
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        if let pickedImage = info[.originalImage] as? UIImage {
            self.koshigoeImage.contentMode = .scaleAspectFit
            self.koshigoeImage.image = pickedImage
        }
    ...
    @IBAction func tapKoshigoeWeb(_ sender: Any) {
