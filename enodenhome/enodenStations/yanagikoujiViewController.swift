//
//  yanagikoujiViewController.swift
//  enodenhome
//
...
class yanagikoujiViewController: UIViewController, UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    @IBOutlet weak var yanagikoujiImage: UIImageView!
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        if let pickedImage = info[.originalImage] as? UIImage {
                       self.yanagikoujiImage.contentMode = .scaleAspectFit
                       self.yanagikoujiImage.image = pickedImage
                   }
    ...
    @IBAction func tapYanagikoujiWeb(_ sender: Any) {
        let nextView = storyboard?.instantiateViewController(withIdentifier: "YanagikoujiWebChoose") as! YanagikoujiWebViewController
