...
class kouenViewController: UIViewController, UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    @IBOutlet weak var kouenImage: UIImageView!
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        if let pickedImage = info[.originalImage] as? UIImage {
                       self.kouenImage.contentMode = .scaleAspectFit
                       self.kouenImage.image = pickedImage
                   }
    ...
    @IBAction func tapKouenWeb(_ sender: Any) {
